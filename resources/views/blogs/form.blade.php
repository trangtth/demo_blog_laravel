...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::text('title', old('title'), ['class' => 'form-control', 'autofocus' => 'autofocus', 'id' => 'title', 'files'=>true, 'enctype' => 'multipart/form-data']) !!}
        @if ($errors)
...
<!-- Blog Image -->
<div class="form-group">
    {!! Form::label('image', 'Choose an image', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-6">
        {!! Form::file('image') !!}
